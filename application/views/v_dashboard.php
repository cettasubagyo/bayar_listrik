...
<body>
	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-fixed-top">
			<div class="brand">
				<a href="<?=base_url()?>index.html"><img src="<?=base_url()?>assets/img/logo-dark.png" alt="Klorofil Logo" class="img-responsive logo"></a>
			</div>
			<div class="container-fluid">
				...
				<div id="navbar-menu">
					<ul class="nav navbar-nav navbar-right">
						...
						<button href="" type="button" class="btn btn-danger">Logout</button>
						<!-- <a href="#"><i class="lnr lnr-exit"></i> <span>Logout</span></a></li> -->
					</ul>
