...
(1, 'cetta', 'cetta', 'subagyo', 1),
(2, 'gecol', 'gecol', 'pramono', 2);
...
ALTER TABLE `pembayaran`
  ...
  ADD KEY `biaya_admin` (`biaya_admin`),
...
ALTER TABLE `penggunaan`
  ...
  ADD KEY `meter_awal` (`meter_awal`),
  ADD KEY `meter_akhir` (`meter_akhir`);
...
ALTER TABLE `tagihan`
  ...
  ADD KEY `jumlah_meter` (`jumlah_meter`),
...
ALTER TABLE `tarif`
  ...
  ADD KEY `tarifperkwh` (`tarifperkwh`);
